<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\wamp64\www\mythinkphp\TP520\blog\public/../application/admin\view\admin\edit.html";i:1532448441;s:74:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\top.html";i:1532356620;s:75:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\left.html";i:1532360516;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>edit</title>
                    ...
                    <div id="horizontal-form">
                        <form class="form-horizontal" role="form" action="" method="post">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="username" placeholder="" name="username" value="<?php echo $user['name']; ?>"
                                           required="" type="text">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" id="password" placeholder="" name="password" value="<?php echo $user['pwd']; ?>"
                                           required="" type="text">
                                </div>
                                <p class="help-block col-sm-4 red">* 必填</p>
                            </div>
