<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"D:\wamp64\www\mythinkphp\TP520\blog\public/../application/admin\view\admin\list.html";i:1532447897;s:74:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\top.html";i:1532356620;s:75:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\left.html";i:1532360516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <div class="page-body">
                ...
                <button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon"
                        onClick="javascript:window.location.href = '<?php echo url('/admin/admin/add'); ?>'"><i
                                ...
                                <div class="flip-scroll">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?php echo url('admin/admin/edit',['id'=>$user['id']]); ?>"
