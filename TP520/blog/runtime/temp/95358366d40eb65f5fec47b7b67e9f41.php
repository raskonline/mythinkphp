<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\wamp64\www\mythinkphp\TP520\blog\public/../application/admin\view\admin\add.html";i:1532446030;s:74:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\top.html";i:1532356620;s:75:"D:\wamp64\www\mythinkphp\TP520\blog\application\admin\view\common\left.html";i:1532360516;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block col-sm-4 red"><?php echo (isset($err['name']) && ($err['name'] !== '')?$err['name']:'* 必填'); ?></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" id="password" placeholder="" name="pwd"
                                                       required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red"><?php echo (isset($err['pwd']) && ($err['pwd'] !== '')?$err['pwd']:'* 必填'); ?></p>
                                        </div>
                                        <div class="form-group">
