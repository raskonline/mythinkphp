...
<!--[if lt IE 9]>
<script src="<?php echo ADMIN_JS_URL;?>html5shiv.js"></script>
...
<body>
	...
	<script src="<?php echo ADMIN_JS_URL;?>chart.min.js"></script>
	<script src="<?php echo ADMIN_JS_URL;?>chart-data.js"></script>
	<script src="<?php echo ADMIN_JS_URL;?>easypiechart.js"></script>
	<script src="<?php echo ADMIN_JS_URL;?>easypiechart-data.js"></script>
	<script src="<?php echo ADMIN_JS_URL;?>bootstrap-datepicker.js"></script>
	<script>
		$('#calendar').datepicker({
		});
