    ...
    <tr>
        <td valign=top align=middle>
            ...
            <table id=child3 style="display: none" cellspacing=0 cellpadding=0
                ...
                <tr height=20>
                    <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL;?>menu_icon.gif" width=9></td>
                    <td><a class=menuchild href="/mythinkphp/TP323/TPMyShop/index.php/Admin/Goods/addgoods" target="right">添加产品</a></td>
                </tr>
                <tr height=20>
                    <td align=middle width=30><img height=9 src="<?php echo ADMIN_IMG_URL;?>menu_icon.gif" width=9></td>
                    <td><a class=menuchild href="/mythinkphp/TP323/TPMyShop/index.php/Admin/Goods/modifygoods" target="right">类目管理</a></td>
                </tr>
                <tr height=20>
                    <td align=middle width=30><img height=9
                                                   src="<?php echo ADMIN_IMG_URL;?>menu_icon.gif" width=9></td>
