        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="/mythinkphp/TP323/TPMyShop/index.php/Admin/Goods/addgoods" target="_self">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <tr id="product1">
                        ...
                        <td><a href="/mythinkphp/TP323/TPMyShop/index.php/Admin/Goods/modifygoods">修改</a></td>
