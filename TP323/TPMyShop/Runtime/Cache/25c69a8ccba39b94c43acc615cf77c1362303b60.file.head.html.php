<?php /* Smarty version Smarty-3.1.6, created on 2018-07-21 15:38:04
...
header_left.jpg"
 ...
 &nbsp;&nbsp; <a style="color: #fff"
                                                        ...
                                                        onclick="if (confirm('确定要退出吗？')) { window.location.href='http://<?php echo $_SERVER['HTTP_HOST'];?>
<?php echo @__MODULE__;?>
/manager/logout'; return true; } else { return false; } "
